...
public class MainActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<ArrayList<Filem>>{
    ...
    private String URL = "https://api.themoviedb.org/3/movie/now_playing?api_key=dac03fc185e46b2a53ef20269a99009e&region=US";
